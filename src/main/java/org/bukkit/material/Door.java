...
public class Door extends MaterialData implements Directional, Openable {
    ...
    public Door() {
        super(BlockTypes.OAK_DOOR.get().getDefaultState());
    }
    ...
    public void setTopHalf(boolean isTopHalf){
        this.spongeValue = this.spongeValue.with(Keys.SLAB_PORTION.get(), (isTopHalf ? SlabPortions.TOP.get() : SlabPortions.BOTTOM.get())).get();
    }
